package com.capstone.autism_training.utilities;
...
public class ImageHelper {
    ...
    public static Bitmap toCompressedBitmap(byte[] image, int requiredSize) {
    ...
    public static Bitmap toCompressedBitmap(byte[] image) {
        BitmapFactory.Options options1 = new BitmapFactory.Options();
        options1.inJustDecodeBounds = true;
        BitmapFactory.decodeByteArray(image, 0, image.length, options1);
